  ...
  return (
    <main className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-center">
        ...
        >
          <option value=":" className="dark:text-black">Sort by</option>
          <option value="price:asc" className="dark:text-black">Price (Low to High)</option>
          <option value="price:desc" className="dark:text-black">Price (High to Low)</option>
          <option value="inStock:asc" className="dark:text-black">Availability (Out of Stock First)</option>
          <option value="inStock:desc" className="dark:text-black">Availability (In Stock First)</option>
        </select>
      </div>
